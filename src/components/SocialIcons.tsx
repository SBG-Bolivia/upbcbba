...
export function Avatar({ name, initials, color, dark, image }: AvatarProps) {
  if (image) {
    return (
  ...
  return (
    <div
      ...
      style={{ background: color, color: dark ? "#060814" : "white" }}
    >
      {initials}
    </div>
  );
...
/** Small GitHub/LinkedIn link row used by member/team cards. */
